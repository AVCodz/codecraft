...
export const useProjectsStore = create<ProjectsState>((set, get) => ({
  ...
  syncWithAppwrite: async (userId: string) => {
    ...
    try {
      ...
      const projects = response.documents as any as Project[];
      ...
      console.log('[ProjectsStore] 📥 Received', projects.length, 'projects from Appwrite');
      console.log('[ProjectsStore] ✨ After deduplication:', uniqueProjects.length, 'unique projects');
