/**
 * GoogleOAuthButton - Google OAuth2 authentication button
 * Initiates Google OAuth2 flow for user authentication
 * Features: Loading states, error handling, Google branding
 * Used in: LoginForm and RegisterForm for OAuth authentication
 */
"use client";
